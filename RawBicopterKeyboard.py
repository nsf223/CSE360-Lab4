...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            # Button inputs: [Z, X, C, V] mapped to [A, B, X, Y] # ws is up down, ad is spinning left right, up & down arrow is forward back 
            ...
            m1 += -0.5 * axis[0] *.2 + (0.1*(0-m1))# Motor 1: a value between 0-1
            m2 += -0.5  * axis[0] *.2 + (0.1*(0-m2))# Motor 2: a value between 0-1
            s1 += (-90 * axis[2] * 0.2 + (0.1*(90-s1))) # Servo 1: a value between 0-180
            s2 += (-90 * axis[2] * 0.2 + (0.1*(90-s2)))# Servo 2: a value between 0-180
            s1 += 90 * axis[1] * 0.2 + (0.1*(90-s1)) # Servo 1: a value between 0-180
            s2 += (-90 * axis[1] * 0.2 + (0.1*(90-s2)))# Servo 2: a value between 0-180
